...
COPY --from=build /app/target/service_paiement_multidevises-0.0.1-SNAPSHOT.jar /app/service_paiement_multidevises.jar

# Spécifier la commande d'exécution
ENTRYPOINT ["java", "-jar", "/app/service_paiement_multidevises.jar"]
